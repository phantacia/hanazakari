    ...
    <div className="bg-discover w-full min-h-screen flex flex-col items-center px-5 py-16 md:p-24 md:flex-row md:items-start">
      <div className="flex flex-col mb-8 md:mr-16">
        ...
        <p className="text-base md:text-lg">
          ...
          the harmonious blend of artistry and culinary finesse. Inspired by
          Kyoto&apos;s cherry blossoms, our journey began during a Hanami
          celebration, culminating in the creation of the first-ever sparkling
          sake infused with Japanese green tea and delicate flowers.
          <br />
          <br />
          Our culture is rooted in a deep appreciation for the ephemeral beauty
          of nature and the transformative power of artistic exploration.
          Haruka&apos;s avant-garde vision and Shizuku&apos;s mixologist
          expertise converge, crafting a unique narrative within each bottle. We
          ...
          tell, and every sip is an ode to tradition and innovation. Currently
          available online and at select stockists across Japan, we invite you
          to join us in raising a glass to the unique culture of Hanazakari.
        </p>
      </div>
